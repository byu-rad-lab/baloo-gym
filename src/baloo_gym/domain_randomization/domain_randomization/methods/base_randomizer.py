...
class BaseDomainRandomizer(ABC):
    ...
    def add(self, parameter_name, distribution, distribution_args):
        ...
        #if distribution not in BaseDomainRandomizer.distribution_fun_dict.keys():
        ...
        #    self.parameter_distributions[parameter_name]['distribution'] = BaseDomainRandomizer.distribution_fun_dict[distribution]
