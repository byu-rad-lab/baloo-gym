...
class PotentialBasedRewardWrapper(gym.Wrapper):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.prev_chest_xpos = get_chest_position(self.unwrapped.model,
                                                  self.unwrapped.data)
    ...
    def _calc_chest_proximity_potential(self, gamma=0.99, phi_weight=1):
        ...
        def phi(chest_xpos, box_xpos):
            ...
            box_xerror_norm = np.linalg.norm(error)

            return box_xerror_norm
